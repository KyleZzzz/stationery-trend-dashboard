...
function renderPromoProducts() {
    ...
    tbody.innerHTML = DASHBOARD_DATA.promoProducts.map(p => `
        <tr class="hover:bg-gray-50">
            ...
            <td class="px-4 py-3 text-right text-gray-400 line-through">¥${p.originalPrice}</td>
            <td class="px-4 py-3 text-right font-bold text-red-600">¥${p.promoPrice}</td>
            <td class="px-4 py-3 text-right"><span class="px-2 py-0.5 text-xs rounded-full bg-red-50 text-red-600 font-bold">${p.discount}</span></td>
